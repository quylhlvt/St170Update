...
import com.dragon.tribe.fire.oc.maker.dialog.CreateNameDialog
...
import com.dragon.tribe.fire.oc.maker.utils.share.telegram.TelegramSharing
import com.dragon.tribe.fire.oc.maker.utils.share.whatsapp.StickerPack
import com.dragon.tribe.fire.oc.maker.utils.share.whatsapp.WhatsappSharingActivity
...
import com.dragon.tribe.fire.oc.maker.utils.share.whatsapp.IdGenerator
import com.dragon.tribe.fire.oc.maker.utils.share.whatsapp.StickerBook
...
//          
    ...
    private fun initNativeCollab() {
        Admob.getInstance().loadNativeCollapNotBanner(this,
            getString(R.string.native_cl_myWork), binding.flNativeCollab)
    }
